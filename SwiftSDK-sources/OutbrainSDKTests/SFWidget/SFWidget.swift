...
class UIViewControllerTransitionCoordinatorMock: NSObject, UIViewControllerTransitionCoordinator {
    override init() {
        ...
        self.presentationStyle = UIModalPresentationStyle(rawValue: 1)!
        self.initiallyInteractive = false
        self.isInterruptible = false
        self.isInteractive = false
        self.isCancelled = false
        self.completionVelocity = 0.0
...
class SFWidgetTests: XCTestCase {
    ...
    func testConfigure() {
        sfWidget.configure(with: mockDelegate, url: "https://example.com", widgetId: "widgetId", installationKey: "installationKey")
    ...
    func testGetCurrentHeight() {
        sfWidget.messageHeightChange(100)
        XCTAssertEqual(sfWidget.getCurrentHeight(), 100)
    }
    ...
    func testConfigureWithAdvancedSettings() {
        sfWidget.configure(with: mockDelegate, url: "https://example.com", widgetId: "widgetId", widgetIndex: 1, installationKey: "installationKey", userId: "userId", darkMode: true)
