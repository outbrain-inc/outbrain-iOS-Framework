...
{
#if 0 // kShouldPrintReachabilityFlags
...
#pragma unused (target, flags)
    ...
    NSCAssert([(__bridge NSObject*) info isKindOfClass: [OBReachability class]], @"info was wrong class in ReachabilityCallback");
...
- (OBNetworkStatus)networkStatusForFlags:(SCNetworkReachabilityFlags)flags
{
    ...
    OBNetworkStatus returnValue = NotReachable;
