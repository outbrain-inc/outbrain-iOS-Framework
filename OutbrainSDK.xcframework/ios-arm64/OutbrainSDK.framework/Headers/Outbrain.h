...
/**
 * @brief Activates/deactivates the Outbrain display ads test mode.
 * Activates display ads test mode which allows to check if the display ads action buttons work correctly.
 */
+ (void)setDisplayTest:(BOOL)displayTest;
