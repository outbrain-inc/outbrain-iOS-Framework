...
//    private var smartFeedManager:SmartFeedManager = SmartFeedManager() // temp initilization, will be replaced in viewDidLoad
...
//        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { [weak alert, self] (_) in
...
//                print("url: \(urlString)")
//                
//                self.paramsViewModel.widgetId = widgetID
//                
//                if (urlString.starts(with: "www")) {
//                    urlString = "https://" + urlString
//                }
//                if (self.verifyUrl(urlString: urlString)) {
//                    paramsViewModel.articleURL = urlString
//                }
//                else {
